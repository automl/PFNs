...
def get_batch(
    ...
    **kwargs,
    ...
    division_size = torch.randint(
        1, max_num_divisions + 1, (batch_size, d), device=device, dtype=torch.long
    )
    ...
    sections = torch.where(
        correct_opt, optima_sections, random_sections
